...
{
    public class EsDetectionManager : MonoBehaviour
    {
        ...
        [SerializeField]
        private EsDetectionSpawnMarkerAnim m_spawnMarker;

        //
        [SerializeField]
        private AudioSource m_placeSound;

        [SerializeField] private EsSentisInferenceUiManager m_uiInference;
        [Space(10)]
        public UnityEvent<int> OnObjectsIdentified;

        private readonly List<EsDetectionSpawnMarkerAnim> m_spawnedEntities = new();
        ...
        {
            var newCount = 0;
            foreach (EsSentisInferenceUiManager.BoundingBoxData box in m_uiInference.m_boxDrawn)
            {
            ...
            bool HasExistingMarkerInBoundingBox(EsSentisInferenceUiManager.BoundingBoxData box)
            {
